...
// instead of props we can directly use the variable name
const Card = ({userName}) => {
            ...
            <div className='border  w-[350px] glass rounded-xl flex'>
                ...
                <div className='px-4 py-4 '>
                    <div className='font-outerSans py-3'>
                     {/* instead of direct name we can use the variable */}
                        <h1>{userName}</h1> 
                        <p className='text-xs'>BoyWithUke</p>
                    </div>
                    <div className='flex w-full justify-evenly  '>
                        <button className='fill-[grey] mx-2 border rounded-full border-black-500 p-1'>
                            <svg
                                width='30'
                                height='30'
                                focusable='false'
                        ...
                        <button
                            className='fill-grey border rounded-full border-black-500 p-1'
